...
function MainBanner() {
  ...
  return (
    <div className='relative'>
        ...
        <img src={assets.main_banner_bg_sm} alt="banner" className={`w-full md:hidden ${open ? "mt-50" :"null"} `}/>
        <div className='absolute inset-0 flex flex-col items-center md:items-start justify-end
          md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
            <h1 className='text-3xl text-emerald-600 md:text-4xl lg:text-5xl font-bold text-center md:text-left
            max-w-72 md:max-w-105 leading-tight leading-15:'
